import { loginWithGoogle, signUp } from "../../apis/api/adapter";
...
const Signup: React.FC = () => {
  ...
  const validateForm = () => {
    ...
    if (password !== confirmPassword) {
      Toast.toastError("Passwords do not match");
      return false;
    }
    if (password.length < 8) {
      Toast.toastError("Password must be at least 8 characters long");
      return false;
    }
    return true;
  };
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-lg transform transition-all duration-300 hover:shadow-xl">
        <div className="text-center">
          ...
          <Typography className="text-sm text-gray-600">
            Join us to get started with your weather dashboard
          </Typography>
        </div>
